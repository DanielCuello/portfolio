  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Daniel Cuello",
          from_email: form.email,
          to_email: "danielcuello.developer@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Muchas gracias! Me comunicare lo mas pronto posible.,");
        ...
        (error) => {
          ...
          alert("Ahh, algo salio mal. Por favor intente nuevamente.");
        }
      );
  };
    ...
    >
      ...
      >
        ...
        >
          ...
          <label className="flex flex-col">
            <span className="text-white font-medium mb-4">Deje su mensaje</span>
            <textarea
              rows={7}
              name="message"
              value={form.message}
